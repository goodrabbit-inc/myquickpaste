...
LOCALES = {
    "ja": pack(
        ...
        {"home": "ホーム", "support": "サポート", "releaseNotes": "リリースノート", "privacy": "プライバシー"},
        {
            ...
            "headline": "MyQuickPaste (MQP) — 画面の隅に置いてワンクリックで素早く貼り付けできる、Windows用コピペ作業効率化・常駐型軽量ツール",
            "features": [
    ...
    "en": pack(
        ...
        {"home": "Home", "support": "Support", "releaseNotes": "Release Notes", "privacy": "Privacy"},
        {
            ...
            "headline": "MyQuickPaste (MQP) — a slim, always-on-top Windows sidekick for faster copy-paste, ready in the corner of your screen with one-click paste",
            "features": [
...
add_locale(
    ...
    hero_block(
        ...
        "MyQuickPaste (MQP) — un outil Windows léger et toujours visible pour coller vos textes en un clic, depuis le coin de l'écran",
...
ext("de", "de", "MyQuickPaste – Mit einem Klick einfügen", "Kopieren Sie täglich denselben Text? Schlankes Windows-Tool, immer im Vordergrund. Kostenlos im Microsoft Store.", "Sprache",
    ...
    "MyQuickPaste (MQP) – schlankes, immer sichtbares Windows-Tool für schnelles Einfügen per Klick in der Bildschirmecke",
...
ext("zh-cn", "zh-CN", "MyQuickPaste - 一键粘贴全文", "还在每天重复复制粘贴相同文字？MyQuickPaste 是常驻屏幕角落的轻量 Windows 工具。Microsoft Store 免费下载。",
    ...
    "是否还在每天反复复制粘贴同样的文字？",
    "MyQuickPaste (MQP) — 放在屏幕角落、一键快速粘贴的 Windows 复制粘贴效率常驻轻量工具",
...
ext("zh-tw", "zh-TW", "MyQuickPaste - 一鍵貼上全文", "還在每天重複複製貼上相同文字？MyQuickPaste 是常駐螢幕角落的輕量 Windows 工具。Microsoft Store 免費下載。",
    ...
    "是否還在每天反覆複製貼上同樣的文字？",
    "MyQuickPaste (MQP) — 放在螢幕角落、一鍵快速貼上的 Windows 複製貼上效率常駐輕量工具",
